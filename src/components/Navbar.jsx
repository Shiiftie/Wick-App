                ...
                return (
                  <motion.button key={id} onClick={() => setView(id)} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
                    style={{
                      ...
                      background: active ? (isSimulator ? 'rgba(0,255,136,0.1)' : 'rgba(232,200,74,0.1)') : 'transparent',
                  ...
                  >
                    ...
                    {active && (
                      <motion.div layoutId="activeTab"
                        style={{ position: 'absolute', bottom: '0px', left: '8px', right: '8px', height: '2px', borderRadius: '2px 2px 0 0', background: isSimulator ? 'linear-gradient(90deg, transparent, #00ff88, transparent)' : 'linear-gradient(90deg, transparent, #e8c84a, transparent)', boxShadow: isSimulator ? '0 0 10px 2px rgba(0,255,136,0.6)' : '0 0 10px 2px rgba(232,200,74,0.6)' }}
              ...
              <motion.button key={id} whileTap={{ scale: 0.9 }} onClick={() => { setView(id); setMenuOpen(false) }}
                ...
                {active && (
                  <motion.div layoutId="bottomTab"
                    style={{ position: 'absolute', top: 0, left: '20%', right: '20%', height: '2px', borderRadius: '0 0 2px 2px', background: isSimulator ? 'linear-gradient(90deg, transparent, #00ff88, transparent)' : 'linear-gradient(90deg, transparent, #e8c84a, transparent)', boxShadow: isSimulator ? '0 0 8px rgba(0,255,136,0.6)' : '0 0 8px rgba(232,200,74,0.6)' }}
                    transition={{ type: 'spring', stiffness: 380, damping: 30 }}
                  />
                )}
